...
//
// The Masternode Class. For managing the Obfuscation process. It contains the input of the 10000 LRM, signature to prove
...
public:
    ...
    static bool ColdCreate(std::string strService, std::string strKeyMasternode, std::string strTxHash, std::string strOutputIndex, std::string best_block, CKey collateralKey, std::string &strErrorRet, CMasternodeBroadcast &mnbRet);
