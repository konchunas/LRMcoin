...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    StartShutdown();
    return "LRMcoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* LRMcoin features */
        {"lrmcoin", "masternode", &masternode, true, true, false},
        {"lrmcoin", "listmasternodes", &listmasternodes, true, true, false},
        {"lrmcoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"lrmcoin", "masternodeconnect", &masternodeconnect, true, true, false},
        ...
        {"lrmcoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"lrmcoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"lrmcoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"lrmcoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"lrmcoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"lrmcoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"lrmcoin", "mnbudget", &mnbudget, true, true, false},
        {"lrmcoin", "preparebudget", &preparebudget, true, true, false},
        {"lrmcoin", "submitbudget", &submitbudget, true, true, false},
        {"lrmcoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"lrmcoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"lrmcoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"lrmcoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"lrmcoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"lrmcoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"lrmcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"lrmcoin", "checkbudgets", &checkbudgets, true, true, false},
        {"lrmcoin", "mnsync", &mnsync, true, true, false},
        {"lrmcoin", "spork", &spork, true, true, false},
        {"lrmcoin", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> lrmcoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:17272/\n";
}
